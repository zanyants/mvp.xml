...
namespace Mvp.Xml.Exslt
{
    ...
    public static class ExsltExtensionMethods
    {
        ...
        /// <returns>The result of the evaluation.</returns>
        public static object ExsltEvaluate( this IXPathNavigable xpn, string xpath, IEnumerable<KeyValuePair< string, string >> namespaces )
        {
            XPathNavigator nav = xpn.CreateNavigator();
            XPathExpression expr = nav.Compile( xpath );

            return ExsltEvaluate( xpn, expr, namespaces );
        }
        ...
        /// </summary>
        /// <param name="xpn">An <c>IXPathNavigable</c> instance.</param>
        /// <param name="expr">XPath epression to be evaluated.</param>
        /// <param name="namespaces">An array of prefix/URI pairs to be added as namespaces to the evaluation context.</param>
        /// <returns>The result of the evaluation.</returns>
        public static object ExsltEvaluate( this IXPathNavigable xpn, XPathExpression expr, IEnumerable<KeyValuePair<string, string>> namespaces )
        {
            XPathNavigator nav = xpn.CreateNavigator();
            ExsltContext ctxt = new ExsltContext( nav.NameTable );
